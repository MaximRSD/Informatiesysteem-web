    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText" style="margin-top:25px; margin-left:30px;">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="position:relative; display:flex;">
                <li class="nav-item">
                    <a class="nav-link active sec-menu" style="margin-right:20px; color:#03274F; font-size:20px;" aria-current="page" href="index.php"><i class="bi bi-house" style="font-size:40px; margin-right:95px; position:relative; color:#03274F;
top:50%;
left:12%;
transform:translate(-50%,-50%);
    vertical-align: middle;"></i></a>
                ...
                <li class="nav-item">
                    <a class="nav-link act-menu" style="margin-right:20px;  color:#03274F; font-size:20px;" href="overzicht.php"><i class="bi bi-journal-richtext" style="font-size:40px; margin-right:62px; color:#03274F; position: relative;
    vertical-align: middle;"></i>Overzicht</a>
                </li>
                <li class="nav-item">
